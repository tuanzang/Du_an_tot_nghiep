...
export const getTotalShippingCostByDay = async (req, res) => {
  const { dateNow } = req.query;
  ...
  try {
    ...
    const totalShippingCost = orders.reduce((total, order) => {
      return total + (order.shippingCost || 0);
    }, 0);
...
export const getTotalShippingCostByWeek = async (req, res) => {
  const { dateStart, dateEnd } = req.query;
...
export const getTotalShippingCostByMonth = async (req, res) => {
  const { dateStart, dateEnd } = req.query;
...
export const getTotalShippingCostByYear = async (req, res) => {
  const { dateStart, dateEnd } = req.query;
...
export const getTotalShippingCostByCustomDay = async (req, res) => {
  const { dateStart, dateEnd } = req.query;
