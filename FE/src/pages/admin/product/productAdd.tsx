...
const ProductAdd = () => {
  ...
  const { register } = useForm<IProduct>();
  ...
  return (
    ...
    >
      <Form.Item<IProduct>
        label="Tên sản phẩm"
        name="name"
        rules={[{ required: true, message: 'Vui lý nhap ten san pham!' }]}
      >
        <Input type='text' />
      </Form.Item>
      <Form.Item<IProduct>
        label="Giá"
        name="price"
        rules={[{ required: true, message: 'Vui lý nhap giá!' }]}
      >
        <Input />
      </Form.Item>
      <Form.Item<IProduct>
      ...
      <Form.Item<IProduct>
        label="Số lượng"
        name="quantity"
        rules={[{ required: true, message: 'Vui lý nhap so luong!' }]}
      >
        <Input />
      </Form.Item>
      <Form.Item<IProduct>
        label="Ảnh"
        name="image"
        rules={[{ required: true, message: 'Vui lý nhap anh!' }]}
      >
        <Input />
      </Form.Item>
      <Form.Item<IProduct>
        label="Mô tả"
        name="description"
        rules={[{ required: true, message: 'Vui lý nhap mota!' }]}
      >
        <Input />
      </Form.Item>
